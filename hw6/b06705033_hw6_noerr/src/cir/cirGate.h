...
{
  public:
    ConstGate(unsigned ID): CirGate("CONST", 0, 0){}
    ~ConstGate(){}
...
{
  public:
    UndefGate(unsigned ID): CirGate("UNDEF", ID, 0){}
    ~UndefGate(){}
...
{
public:
    CirPiGate(unsigned ID, unsigned No): CirGate("PI", ID, No){}
     ~CirPiGate() {}
    void printGate() const;
...
{
public:
    CirPoGate(unsigned ID, unsigned No, unsigned fanin, bool inv): CirGate("PO", ID, No, fanin, inv) {}
     ~CirPoGate() {}
    void printGate() const;
